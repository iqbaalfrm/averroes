    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 16),
          _buildStatRow('Market Cap', coin.marketCapFormatted),
          _buildStatRow('Volume 24h', coin.volumeFormatted),
          _buildStatRow('Perubahan 7h', coin.change7dFormatted, 
            isChange: true, isUp: coin.change7d >= 0),
          _buildStatRow('Ranking', coin.marketCapRank != null ? '#${coin.marketCapRank}' : '-'),
        ],
      ),
    );
  }
