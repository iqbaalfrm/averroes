...
import '../modules/beranda/beranda_view.dart';
...
class AppPages {
  ...
  static final routes = [
    ...
    GetPage(
      name: Routes.HOME,
      page: () => const MainLayoutView(), // Use MainLayout
      // Home bisa diakses Guest, jadi AuthGuard di sini tricky.
      // logic guest vs user ada di BerandaView sendiri untuk hide/show fitur.
      // TAPI jika user login tapi unverified, mereka TIDAK BOLEH masuk Home.
